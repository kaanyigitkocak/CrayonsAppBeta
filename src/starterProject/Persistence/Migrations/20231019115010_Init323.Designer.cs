...
namespace Persistence.Migrations
{
    ...
    [Migration("20231019115010_Init323")]
    partial class Init323
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Core.Security.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = new byte[] { 109, 99, 135, 255, 160, 232, 32, 86, 41, 40, 65, 85, 128, 96, 199, 67, 141, 38, 68, 0, 55, 241, 103, 101, 1, 255, 227, 159, 119, 227, 197, 131, 227, 105, 190, 80, 44, 243, 91, 183, 91, 37, 19, 197, 35, 90, 166, 227, 208, 118, 4, 167, 134, 12, 131, 26, 102, 13, 192, 129, 118, 222, 22, 163 },
                            PasswordSalt = new byte[] { 211, 207, 240, 197, 243, 97, 1, 82, 29, 94, 124, 209, 239, 237, 248, 12, 171, 143, 65, 180, 102, 5, 42, 151, 64, 229, 134, 31, 120, 87, 90, 190, 93, 199, 12, 243, 112, 26, 119, 69, 91, 225, 182, 3, 224, 247, 57, 109, 5, 231, 102, 37, 124, 184, 124, 40, 139, 97, 136, 14, 86, 5, 206, 188, 108, 75, 196, 161, 135, 97, 52, 38, 2, 6, 147, 6, 57, 78, 98, 222, 242, 182, 97, 78, 57, 80, 67, 124, 113, 135, 99, 206, 73, 236, 191, 16, 142, 41, 15, 39, 179, 192, 166, 29, 181, 151, 237, 79, 55, 35, 29, 53, 73, 236, 182, 242, 215, 127, 23, 13, 47, 173, 254, 15, 125, 223, 163, 251 },
                            Status = true
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.School", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Address = "123 Main St",
                            CreatedDate = new DateTime(2023, 10, 19, 14, 50, 10, 503, DateTimeKind.Local).AddTicks(2450),
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 10, 19, 14, 50, 10, 503, DateTimeKind.Local).AddTicks(2470),
